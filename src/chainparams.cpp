...
{
    const char* pszTimestamp = "BBC News 14/05/2019 Bitcoin price surges over ,000";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1558267649, 2084563694, 0x1e0ffff0, 1, 25 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("172a62c5a352086c3290c7b59084e0a19b64f47fb89b030c08a5fea168a9b7cb"));
        assert(genesis.hashMerkleRoot == uint256S("04fbc70bae789debcd00d018b65b3e7874ced92deb1039104a7433ed83e8f3d8"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.emplace_back("dnsseed.jacobbowerman.com", true);
        //vSeeds.emplace_back("seed-a.tooncoin.loshan.co.uk", true);
        //vSeeds.emplace_back("dnsseed.thrasher.io", true);
        //vSeeds.emplace_back("dnsseed.tooncointools.com", true);
        //vSeeds.emplace_back("dnsseed.tooncoinpool.org", true);
        ...
        checkpointData = (CCheckpointData) {
            {
                {     0, uint256S("172a62c5a352086c3290c7b59084e0a19b64f47fb89b030c08a5fea168a9b7cb")},
        ...
        chainTxData = ChainTxData{
            ...
            1558267649, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.tooncointools.com", true);
        vSeeds.emplace_back("seed-b.tooncoin.loshan.co.uk", true);
