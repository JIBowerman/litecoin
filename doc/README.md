...
To download Tooncoin Core, visit [litecoin.org](https://litecoin.org).
...
* See the documentation at the [Tooncoin Wiki](https://litecoin.info/)
...
* Ask for help on the [TooncoinTalk](https://litecointalk.io/) forums.
...
### Resources
* Discuss on the [TooncoinTalk](https://litecointalk.io/) forums.
* Discuss general Tooncoin development on #litecoin-dev on Freenode. If you don't have an IRC client use [webchat here](http://webchat.freenode.net/?channels=litecoin-dev).
